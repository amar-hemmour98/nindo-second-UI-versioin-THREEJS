...
// Objects
const geometry = new THREE.TorusGeometry( .7, .2, 160, 10 );

// to test add smallTorus in torus with reverse animation .
const smallTorusGeo = new THREE.TorusGeometry( .35, .1, 50, 100);
...
scene.add(sphere,smallTorus,pointLight)
...
const tick = () =>
{
    ...
    //test
    smallTorus.rotation.x = .5 * elapsedTime
    smallTorus.rotation.y = -.7* elapsedTime
    ...
    //     sphere.rotation.y =  (elapsedTime *.7) *mouseY*0.0005 
    //     sphere.rotation.x = (elapsedTime *.7)*mouseX*0.0005
